...
function animatedfsmenu_register_theme_options_metabox() {
	...
	$cmb_options->add_field(
		array(
			...
			'desc' => ( $pro_user ? esc_html__( 'Background Image when menu is opened. Leave blank to use colors above.', 'animated-fullscreen-menu' ) : esc_html__( 'Please upgrade your plugin at Fullscreen Menu options->Get Pro Features', 'animated-fullscreen-menu' ) ),
	...
	$cmb_options->add_field(
		array(
			...
			'desc'          => ( $pro_user ? esc_html__( 'Background Video when menu is opened. Leave blank to use colors or image above.', 'animated-fullscreen-menu' ) : esc_html__( 'Please upgrade your plugin at Fullscreen Menu options->Get Pro Features', 'animated-fullscreen-menu' ) ),
	...
	$cmb_options->add_field(
		array(
			...
			'desc'    => ( $pro_user ? esc_html__( 'Open all menu levels.', 'animated-fullscreen-menu' ) : esc_html__( 'Please upgrade your plugin at Fullscreen Menu options->Get Pro Features', 'animated-fullscreen-menu' ) ),
	...
	$cmb_options->add_field(
		array(
			...
			'desc'       => ( $pro_user ? esc_html__( 'Activate this option for displaying more than one level of submenu. <br>Example: About Us>Team>John Smith.', 'animated-fullscreen-menu' ) : esc_html__( 'Please upgrade your plugin at Fullscreen Menu options->Get Pro Features', 'animated-fullscreen-menu' ) ),
	...
	$cmb_options->add_field(
		array(
			...
			'desc'       => ( $pro_user ? esc_html__( 'Font Size for Menu Text. Examples: 12px, 4rem, 2em', 'animated-fullscreen-menu' ) : esc_html__( 'Please upgrade your plugin at Fullscreen Menu options->Get Pro Features', 'animated-fullscreen-menu' ) ),
	...
	$cmb_options->add_field(
		array(
			...
			'desc'          => ( $pro_user ? esc_html__( 'Activate a shadow for all text elements', 'animated-fullscreen-menu' ) : esc_html__( 'Please upgrade your plugin at Fullscreen Menu options->Get Pro Features', 'animated-fullscreen-menu' ) ),
	...
	$cmb_options->add_field(
		array(
			...
			'desc'          => ( $pro_user ? esc_html__( 'The position of the horizontal shadow', 'animated-fullscreen-menu' ) : esc_html__( 'Please upgrade your plugin at Fullscreen Menu options->Get Pro Features', 'animated-fullscreen-menu' ) ),
	...
	$cmb_options->add_field(
		array(
			...
			'desc'          => ( $pro_user ? esc_html__( 'The position of the vertical shadow', 'animated-fullscreen-menu' ) : esc_html__( 'Please upgrade your plugin at Fullscreen Menu options->Get Pro Features', 'animated-fullscreen-menu' ) ),
	...
	$cmb_options->add_field(
		array(
			...
			'desc'          => ( $pro_user ? esc_html__( 'The blur radius', 'animated-fullscreen-menu' ) : esc_html__( 'Please upgrade your plugin at Fullscreen Menu options->Get Pro Features', 'animated-fullscreen-menu' ) ),
	...
	$cmb_options->add_field(
		array(
			...
			'desc'          => ( $pro_user ? esc_html__( 'The color of the shadow', 'animated-fullscreen-menu' ) : esc_html__( 'Please upgrade your plugin at Fullscreen Menu options->Get Pro Features', 'animated-fullscreen-menu' ) ),
	...
	$cmb_options->add_field(
        ...
        $cmb_options->add_field(
			array(
				...
				'desc'        => ( $pro_user ? esc_html__( 'Select the position for the Burger.', 'animated-fullscreen-menu' ) : esc_html__( 'Please upgrade your plugin at Fullscreen Menu options->Get Pro Features', 'animated-fullscreen-menu' ) ),
        ...
        $cmb_options->add_field(
			array(
				...
				'desc'    		=> ( $pro_user ? esc_html__( 'Replace the burger button for a custom image.', 'animated-fullscreen-menu' ) : esc_html__( 'Please upgrade your plugin at Fullscreen Menu options->Get Pro Features', 'animated-fullscreen-menu' ) ),
		...
		$cmb_options->add_field(
			array(
				...
				'desc'    		=> ( $pro_user ? esc_html__( 'Align the text to the following.', 'animated-fullscreen-menu' ) : esc_html__( 'Please upgrade your plugin at Fullscreen Menu options->Get Pro Features', 'animated-fullscreen-menu' ) ),
		...
		$cmb_options->add_field(
			array(
				...
				'desc'    		=> ( $pro_user ? __( 'Disafix the Burger Button on the DOM', 'animated-fullscreen-menu' ) : esc_html__( 'Please upgrade your plugin at Fullscreen Menu options->Get Pro Features', 'animated-fullscreen-menu' ) ),
		...
		if ( class_exists( 'WooCommerce' ) ) :
			...
			$cmb_options->add_field(
				array(
					...
					'desc' 			=> ( $pro_user ? esc_html__( 'Display a carousel with the products the user has in cart', 'animated-fullscreen-menu' ) : esc_html__( 'Please upgrade your plugin at Fullscreen Menu options->Get Pro Features', 'animated-fullscreen-menu' ) ),
